...
public class WaveView extends View {
    ...
    public static class WaveData {
         ...
         * fixedHeight   The fixed height of the valley from the bottom of the View, equivalent to the marginBottom of this wave
         * offset    Initial position of the wave
         * startColor    The color to the left of the gradient
         * endColor      The color to the right of the gradient
         * alpha     transparency
         * duration  Fluctuation cycle, the time required to go one wavelength
         * right Whether to move to the right
         * sampleSize Draw a sine curve with path, sample points taken in one cycle
         * gradientOrientation Gradient direction
         *
         */
